...
namespace Lithnet.ActiveDirectory.PasswordProtection.PowerShell
{
    ...
    public class RemoveCompromisedPassword : PSCmdlet
    {
        ...
        {
            Global.Store.RemoveFromStore(this.ParameterSetName == "String" ? this.Value : this.SecureString.SecureStringToString(), PasswordProtection.StoreType.Password);
        }
    }
}
