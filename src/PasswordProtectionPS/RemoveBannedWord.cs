...
namespace Lithnet.ActiveDirectory.PasswordProtection.PowerShell
{
    ...
    public class RemoveBannedWord : PasswordProtectionCmdletBase
    {
        ...
        {
            Global.Store.RemoveFromStore(this.ParameterSetName == "String" ? this.Value : this.SecureString.SecureStringToString(), StoreType.Word);
        }
    }
}
