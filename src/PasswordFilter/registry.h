...
static LPCWSTR REG_VALUE_HIBPSHA1APIURL = L"HibpSha1ApiUrl";
static LPCWSTR REG_VALUE_HIBPNTLMHEXAPIURL = L"HibpNtlmHexApiUrl";
static LPCWSTR REG_VALUE_HIBPNTLMBINARYAPIURL = L"HibpNtlmBinaryApiUrl";
static LPCWSTR REG_VALUE_HIBPNTLMBINARYPWNCOUNTAPIURL = L"HibpNtlmBinaryPwnCountApiUrl";
