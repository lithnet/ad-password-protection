...
extern const MIDL_SERVER_INFO passwordfilter_ServerInfo;

extern const RPC_DISPATCH_TABLE passwordfilter_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE passwordfilter___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x1a5a3e3e,0xfdc9,0x4b21,{0xb7,0x46,0x58,0x97,0xf9,0x3e,0xf8,0x49}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&passwordfilter_v1_0_DispatchTable,
    0,
    0,
    0,
    &passwordfilter_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE passwordfilter_v1_0_s_ifspec = (RPC_IF_HANDLE)& passwordfilter___RpcServerInterface;
...
static const RPC_DISPATCH_FUNCTION passwordfilter_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE passwordfilter_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)passwordfilter_table
    };
...
static const MIDL_STUB_DESC passwordfilter_StubDesc = 
    {
    (void *)& passwordfilter___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& passwordfilter_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION passwordfilter_NDR64__table[] =
    {
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE passwordfilter_NDR64__v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)passwordfilter_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO passwordfilter_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&passwordfilter_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE passwordfilter_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)GetPasswordFilterResult
    };

static const MIDL_SERVER_INFO passwordfilter_ServerInfo = 
    {
    &passwordfilter_StubDesc,
    passwordfilter_ServerRoutineTable,
    lpp__MIDL_ProcFormatString.Format,
    (unsigned short *) passwordfilter_FormatStringOffsetTable,
    0,
